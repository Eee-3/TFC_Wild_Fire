...
ServerEvents.recipes(event => {
    ...
    wash_ore.forEach(ore => {
        ...
        if (ore.type == '/type_') {
            ...
            if (ore.mod == 'tfc_ie_addon:ore') { event.shapeless(`kubejs:item/ore/dust_lump/${ore.ore}`, `4x tfc_ie_addon:powder/${ore.ore}`).id(`${recipedid}shapeless/1/dust_lump/powder/${ore.ore}`) }//小团矿
            if (ore.mod == 'firmalife:ore') { event.shapeless(`kubejs:item/ore/dust_lump/${ore.ore}`, `4x firmalife:powder/${ore.ore}`).id(`${recipedid}shapeless/1/dust_lump/powder/${ore.ore}`) }//小团矿
            if (ore.mod == 'tfc:ore') { event.shapeless(`kubejs:item/ore/dust_lump/${ore.ore}`, `4x tfc:powder/${ore.ore}`).id(`${recipedid}shapeless/1/dust_lump/powder/${ore.ore}`) }//小团矿
        }
