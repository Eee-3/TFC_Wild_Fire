StartupEvents.init(event => {
    ...
    */
   // 霜冻：非常寒冷，可能导致冻伤
    Config.setTemperatureEnum("frostbite", 0, 6)
    
    // 寒冷：需要保暖的温度
    Config.setTemperatureEnum("cold", 6, 13)

    // 正常：舒适的温度范围
    Config.setTemperatureEnum("normal", 13, 26)

    // 炎热：需要降温的温度
    Config.setTemperatureEnum("hot", 26, 33)

    // 中暑：危险的高温
    Config.setTemperatureEnum("heat_stroke", 33, 43)
})